1|30|bottom|( cpu memory ) ( clock )|( wlr/workspaces hyprland/window )|( network bluetooth pulseaudio pulseaudio#microphone custom/updates battery) ( tray ) ( custom/wallchange custom/mode custom/wbar custom/cliphist custom/power )
